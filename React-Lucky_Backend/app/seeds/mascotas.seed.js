...
const mascotas = [
  {
    ...
    tamano: 'Pequeño',
    peso: 3.6,
    personalidad: ['Juguetón', 'Bueno con niños', 'Cauteloso', 'Tímido'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Grande',
    peso: 4.4,
    personalidad: ['Cariñosa', 'Tranquila', 'Amable', 'Revoltosa'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Mediano',
    peso: 4,
    personalidad: ['Tranquilo','Curioso', 'Travieso', 'Dormilón', 'A veces maúllo...'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: 10,
    personalidad: ['Juguetón', 'Activo', 'Se lo come todo', 'A veces ladro...'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Mediano',
    peso: 14.5,
    personalidad: ['Tranquilo', 'Miedoso', 'Amante del sofa', 'De estómago sensible...'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Grande',
    peso: 25,
    personalidad: ['Buena', 'Mayor', 'Tranquila', 'Amante de la naturaleza'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: 1,
    personalidad: ['Juguetón','Inquieto', 'Comilón'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Mediano',
    peso: 2,
    personalidad: ['Tranquila','Rápida', 'Exploradora'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: 0.5,
    personalidad: ['Juguetón','Manso', 'Cariñoso', 'Me gustan las pipas...'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: 0.5,
    personalidad: ['Dormilón','Tímdo', 'Miedoso'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: 0.7,
    personalidad: ['Nervioso', 'Juguetón', 'A veces muerdo...'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: 1,
    personalidad: ['Buen comedor', 'Cariñoso', 'Dormilón'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Mediano',
    peso: 1.2,
    personalidad: ['Juguetona','Inquieta', 'Aventurera'] ,
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: 0.9,
    personalidad: ['Curiosa','Dormilona', 'De buen comer', 'Graciosa'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Mediano',
    peso: '2',
    personalidad: ['Cariñosa', 'Tranquila'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Grande',
    peso: '3',
    personalidad: ['Con carácter', 'Tranquilo', 'Amante de la luz solar'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: '0.5',
    personalidad: ['Graciosa', 'Movida', 'Con carácter', 'Cabezota'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: '0.4',
    personalidad: ['Juguetón', 'Gracioso', 'De buen comer', 'A veces hago ruido...'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Mediano',
    peso: '0.9',
    personalidad: ['Tranquilo', 'De buen comer', 'Observador'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: '0.200',
    personalidad: ['Silencioso', 'Trabajador'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Mediano',
    peso: '0.450',
    personalidad: ['Hablador', 'Gracioso', 'Me gusta volar...'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: '0.3',
    personalidad: ['Juguetón', 'Alegre', 'Cariñoso', 'Animado'],
    historia: '',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: '0.3',
    personalidad: ['Timido', 'Bueno con los niños', 'Cauteloso', 'Juguetón'],
    historia: 'Me llamo Blue, era un pajarito muy bueno, pero vi cosas que no debería haber visto, que no debíann haber pasado. Por eso llamaron a LARA y vino a salvarnos la vida',
  ...
  },
  {
    ...
    tamano: 'Pequeño',
    peso: '0.3',
    personalidad: ['Silencioso', 'Gracioso', 'Tranquilo', 'Observador'],
    historia: '',
